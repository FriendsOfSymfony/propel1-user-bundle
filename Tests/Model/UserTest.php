...
namespace FOS\Propel1UserBundle\Tests\Model;

use FOS\Propel1UserBundle\Model\Group;
use FOS\Propel1UserBundle\Model\User;
use FOS\Propel1UserBundle\Model\UserPeer;
use FOS\Propel1UserBundle\Model\UserQuery;
...
class UserTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSerialize()
    {
        ...
        $this->assertInstanceOf('FOS\Propel1UserBundle\Model\User', $unserialized);
